...
/*   Updated: 2023/09/24 12:03:04 by ahammout         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
    ...
    * When the join command seccused the client will recieve RPL_TOPIC or RPL_NOTOPIC as confirmation to it's joining to the channel.
*/
...
/// @brief This funciton will split the parameters to channelNames & channelKeys.
/// @param ChannelNames 
/// @param ChannelKeys 
/// @param ProcessMessage 
/// @return 0 When the 0 as parameter catched.
/// @return -1 in failure.
/// @return 1 when seccuss.
...
void ExecuteCommands::join(ServerReactor &_serverReactor, Message &ProcessMessage, int clientSocket)
{
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ LEAVE ALL THE CHANNELS INSIDE THE SERVER ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
    if (stat == 0){
    ...
    for (unsigned int i = 0; i < ChannelNames.size(); i++){
        ...
        // Channel is exist, Check Security cases, and inform all the channels clients.
            ...
            // JUMP TO THE CHANNEL INTERFACE.
        }
    }
    
    // *** SEE ALL SERVER CAHNNEL *****/
    // *** SEE ALL THE CHANNELS SERVER CLIENTS AND OPERATORS INSIDE THE SERVER ****/
    map<string, ChannelData>::iterator  it;
